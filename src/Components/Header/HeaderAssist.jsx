      ...
      <header className={scrolled ? 'solid' : ''}>
        ...
        <nav className='nav-points'>
          <Link
            ...
            onClick={() => handleLinkClick('prestamos')}
          >
            Inicio
          </Link>
          <a
            href="/asistencias#multiasistencia"
            className={selectedLink === 'multiasistencia' ? 'link-selected' : ''}
            onClick={() => handleLinkClick('multiasistencia')}
          >
            Multiasistencia
          </a>
          <a
            href="/asistencias#salud"
            className={selectedLink === 'salud' ? 'link-selected' : ''}
            onClick={() => handleLinkClick('salud')}
          >
            Asistencia en Salud
          </a>
          <a
            href="/asistencias#desempleo"
            className={selectedLink === 'desempleo' ? 'link-selected' : ''}
            onClick={() => handleLinkClick('desempleo')}
          >
            Asistencia en Desempleo
          </a>
          <a
            href="/asistencias#contacto"
        ...
        <div className={isOpen ? 'mobible-navbar-points open-points' : (first ? 'mobible-navbar' : 'mobible-navbar not-first-points')}>
          <nav className='mobible-links-points'>
            <button onClick={handleCloseNabvar} className='btn-back-points'>
              <IoMdArrowBack />
            </button>

            <Link
              to="/"
              className={selectedLink === 'inicio' ? 'link-selected' : ''}
              onClick={() => { handleLinkClick('inicio'); handleCloseNabvar(); }}
            >
              Inicio
            </Link>
            <a
              href="/asistencias#multiasistencia"
              className={selectedLink === 'multiasistencia' ? 'link-selected' : ''}
              onClick={() => { handleLinkClick('multiasistencia'); handleCloseNabvar(); }}
            >
              Multiasistencia
            </a>
            <a
              href="/asistencias#salud"
              className={selectedLink === 'salud' ? 'link-selected' : ''}
              onClick={() => { handleLinkClick('salud'); handleCloseNabvar(); }}
            >
              Asistencia en Salud
            </a>
            <a
              href="/asistencias#desempleo"
              className={selectedLink === 'desempleo' ? 'link-selected' : ''}
              onClick={() => { handleLinkClick('desempleo'); handleCloseNabvar(); }}
            >
              Asistencia en Desempleo
            </a>
            <a
              href="/asistencias#contacto"
              className={selectedLink === 'contacto' ? 'link-selected' : ''}
              onClick={() => { handleLinkClick('contacto'); handleCloseNabvar(); }}
            >
              Contacto
            </a>
          </nav>

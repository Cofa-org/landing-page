...
export const termsAndConditions = [
    ...
    {
        content: 'COFA en cualquier momento y a su solo arbitrio, podrá disponer la suspensión o inhabilitación temporal o definitiva para el acceso del Usuario a www.cofa.com.ar.'
    },
    {
        content: 'Registro. El Usuario que cumpla con los requisitos precedentemente establecidos para utilizar la aplicación y/o los servicios de COFA deberá, como condición ineludible y de procedencia, completar el formulario de registración que se pone a su disposición en www.cofa.com.ar, informando, con el carácter de declaración jurada, los siguientes datos: nombre y apellido, sexo, fecha de nacimiento, número de documento nacional de identidad, domicilio real, dirección de correo electrónico y número de celular. Sin perjuicio de lo anterior, COFA se reserva el derecho de requerir cualquier información y/o documentación adicional a los efectos del cumplimiento de cualquier normativa que resulte aplicable y/o que considere oportuna.'
    },
    {
    ...
    {
        content: 'COFA no será responsable por las eventuales consecuencias, de cualquier tipo que fuera, resultantes de fallas en el sistema, en el servidor o en Internet que pudieran surgir del acceso y/o uso de www.cofa.com.ar bajo cualquier modalidad que el Usuario empleara ni será responsable por eventuales errores u omisiones contenidos en el uso de la página web.'
    },
    {
        content: 'COFA no garantiza el acceso y/o uso continuado o ininterrumpido de www.cofa.com.ar, ya que el sistema puede eventualmente no estar disponible debido a dificultades técnicas o fallas de Internet. No obstante, se compromete a realizar sus mejores esfuerzos para procurar restablecer el sistema con la mayor celeridad posible sin que por ello pueda imputársele algún tipo de responsabilidad.'
    },
    {
        content: 'El Usuario presta su consentimiento para que COFA a través de www.cofa.com.ar pueda utilizar los datos aportados por el Usuario para enviar información y/o promociones y/o publicidad asociada a COFA y sus servicios.'
    },
    {
        content: 'La obtención de una Cuenta en www.cofa.com.ar por el Usuario es gratuita y constituye una condición de procedencia ineludible para el uso y/o goce de las aplicaciones y/o servicios que provee COFA. COFA se reserva el derecho a cancelar una activación previamente aceptada, sin que esté obligado a comunicar o exponer las razones de su decisión y sin que ello genere derecho alguno a favor del Usuario.'
    },
    {
    ...
    },
    {
        ...
        subcontent: [
            ...
            {
                content: ' Adicionalmente, COFA podrá cobrar un cargo del 5% mensual sobre la deuda existente con más el IVA correspondiente (el cual será adicionado), por gastos administrativos iniciales que exige cualquier procedimiento de seguimiento de mora y gestión de cobranza.'
            }
        ]
    },
    {
        content: 'Se deja expresamente aclarado que COFA es un Proveedor No Financiero de Crédito inscripto ante el Banco Central de la República Argentina bajo el Nº 55287, pero no presta al Usuario ningún servicio bancario ni cambiario.'
    },
    {
        content: 'Actividad de Agente Institorio. Seguros.',
        subcontent: [
            { 
                content:'Se deja expresamente aclarado que COFA es agente institorio inscripto ante la Superintendencia de Seguros de la Nación bajo el nro 334.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        [
            {
                content: 'El Usuario acepta la plena validez de las notificaciones enviadas entre las partes a través de www.cofa.com.ar y/o por correo electrónico, destacándose que el presente contrato se conviene sobre la base de la buena fe contractual y el deber de colaboración de las partes.'
            }
        ]
    },
    {
...
export const termsAndConditionsPoints = [
    ...
    },
    {
        ...
        subcontent: [
            ...
            {
                content:'Completen y envíen la encuesta de satisfacción que se remite a cada Cliente luego del alta de algún producto o servicio en COFA. La misma debe ser enviada a consultas@cofa.com.ar desde el mail del Cliente.'
            },
            {
                content:'Finalicen un préstamo en el plazo acordado y hayan abonado todas las cuotas en tiempo y forma, y sin atrasos mayores a 30 días corridos del vencimiento de cada una.'
            },
            {
            ...
            {
                content:'Sean seguidores de las cuentas de COFA en las Redes Sociales “Instagram” y/o “Facebook”. Para sumar puntos deben informar a COFA, vía whatsapp o mail, el nombre de usuario con el cual se ha comenzado a ser seguidor y en qué red social.'
            }
        ]
    },
    {
    ...
    {
        content: 'Acreditación y vencimiento de Puntos: Los Puntos acumulados bajo el Programa sólo podrán ser canjeados y/o utilizados por los Clientes para obtener:',
        subcontent:[
            {
                content:' ',
                subcontent:[
            ...
            },
            {
                ...
                subcontent:[
                    ...
                    {
                        content:'La fecha en que el cliente informe que comenzó a seguir a COFA en las Redes Sociales “Instagram” y/o “Facebook”.'
                    },
                ]
            },
            {
    ...
    },
    {
        ...
        subcontent:[
            ...
            {
                content:'No podrán participar del programa aquellas personas o empresas que sean empleados de COFA, ni proveedores, ni comercializadores de algún producto. '
            },
        ]
    },
    {
    ...
    {
        content:'Descuento: COFA podrá descontar de la cuenta de los Clientes, sin notificación ni aviso previo, los Puntos acreditados por error o relacionados con una transacción que hubiere sido cancelada, revertida o ajustada, o que se hubieran obtenido contrariando lo dispuesto en este Reglamento o de cualquier otra forma desleal, fraudulenta o engañosa.'
    },
    {
        content:'Comunicación: Los puntos deberán ser utilizados y/o canjeados por los Clientes enviado una solicitud expresa por mail a COFA a la siguiente dirección de correo electrónico: consultas@cofa.com.ar o a través de su cuenta personal en www.cofa.com.ar (Página Web de COFA).'
    },
    {
    ...
    {
        content: 'Valor de los Puntos: 1 Punto canjeado equivale a un premio equivalente a la reducción en el pago del servicio elegido por la suma de ar$10. (sujeto a los requisitos detallados en el Reglamento).',
        subcontent: [
            {
                content:'Por cada referido que:',
                subcontent: [
                    {
                        content: 'Efectivamente solicite y firme un (1) primer préstamo con COFA y mantenga vigente el mismo durante el plazo mínimo aplicable, sin ejercer derecho de arrepentimiento o revocación: 400 Puntos en el Programa.',
                        subcontent: [
                            {
                                content: 'El cliente que haya referido a cinco (5) REFERIDOS que adquieran al menos un (1) primer préstamo cada uno, en el transcurso de un año calendario, recibirá el doble de puntos a partir del sexto Referido de préstamos. (conf. cláusula 15.A.I.)'
                            }
                        ]
                    },
                    {
                        content: 'Efectivamente solicite una (1) primera asistencia COFA y la mantenga activa y al día por al menos tres (03) meses consecutivos: 100 Puntos en el Programa.',
                        subcontent: [
                            {
                                content: 'El cliente que haya referido a cinco (5) REFERIDOS que adquieran al menos una (1) primera asistencia, en el transcurso de un año calendario, recibirá el doble de puntos a partir del sexto Referido de asistencias (conf. cláusula 15.A.II.)'
                            }
                        ]
                    },
                ]
            ...
            {
                content:'Por seguir a COFA en las Redes Sociales “Instagram” y/o “Facebook”: 200 puntos en el programa.'
            },
            {
    ...
    },
    {
        ...
        subcontent: [
            ...
            {
                content:'Los seguidores en las Redes Sociales “Instagram” y/o “Facebook” que luego de informar que han comenzado a seguir, no continuaran siguiendo; en este caso, una vez detectado que han dejado de cumplir con este requisito, se quitarán los puntos otorgados.'
            }
        ]
    },
    {
    ...
    {
        content:'Domicilio: Para todos los efectos legales del presente el Cliente constituye domicilio en el lugar establecido en el último préstamo que haya tomado con COFA, y COFA en Moreno 1628 piso 3° oficina 35 CABA. Son igualmente válidas las comunicaciones y notificaciones enviadas por COFA al mail registrado por el cliente, y las comunicaciones y notificaciones enviadas por el cliente a COFA a consultas@cofa.com.ar.'
    },
    {
...
export const clientReview = [
    ...
    {
        content: 'Todo el proceso para que me otorguen el préstamo fue muy fácil, rápido y lo hice desde mi celular. Había sacado préstamos en otras empresas, pero me quedo con COFA.',
        author: 'Brenda'
    }
]
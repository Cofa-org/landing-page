    ...
    <>
        <section className='value-container' id='valor'>
            <div className='info'>
                ...
                <button className='primary-btn btn-refer' onClick={() => window.callbell && window.callbell('open')}>Referir A Un Amigo <GoArrowRight /></button>
            </div>
        ...
        <div className='container-btn-temrs'>
            <Link to={'/terminos-y-condiciones-puntos-cofa'} className='secondary-btn btn-terms' >
